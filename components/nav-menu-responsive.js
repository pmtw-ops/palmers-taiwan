      ...
      <div className="z-0 relative">
        ...
        <div className="hidden md:flex md:items-center md:justify-between md:relative md:z-10 md:bg-white">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8 md:px-4">
            <Link href="#" passHref>
              <svg className="opacity-50 hover:opacity-100 focus:opacity-100" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd"><path d="M19.757 20.171c-.791.524-1.739.829-2.757.829-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5c0 1.018-.305 1.966-.829 2.757l2.829 2.829-1.414 1.414-2.829-2.829zm-7.654.829h-12.103v-20h7c1.695 1.942 2.371 3 4 3h11v7.103c-1.271-1.297-3.042-2.103-5-2.103-3.863 0-7 3.137-7 7 0 1.958.806 3.729 2.103 5zm4.897-8c1.656 0 3 1.344 3 3s-1.344 3-3 3-3-1.344-3-3 1.344-3 3-3z" /></svg>
            </Link>
            <Link href="#" passHref>
              <svg className="opacity-50 hover:opacity-100 focus:opacity-100" width="24" height="24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd"><path d="M13 2v-2l10 3v18l-10 3v-2h-9v-7h1v6h8v-18h-8v7h-1v-8h9zm-2.947 10l-3.293-3.293.707-.707 4.5 4.5-4.5 4.5-.707-.707 3.293-3.293h-9.053v-1h9.053z" /></svg>
            </Link>
          </div>
        </div>
